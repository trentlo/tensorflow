  ...
  BufferAssignment(const HloModule* module,
      ...
      : module_(module),
        ...
        hlo_live_range_(std::move(hlo_live_range)) {
          int32 raw_value = module->config().debug_options().xla_multiheap_size_constraint_per_heap();
          // -1 means no constraint.
          multiheap_size_constraint_per_heap_ = (raw_value==-1)? UINT64_MAX : raw_value;
        }
